...
static const ProtobufCEnumValue extensions__api__cast_channel__cast_message__protocol_version__enum_values_by_number[1] =
{
...
static const ProtobufCEnumValueIndex extensions__api__cast_channel__cast_message__protocol_version__enum_values_by_name[1] =
{
  { "CASTV2_1_0", 0 },
};
...
static const ProtobufCEnumValue extensions__api__cast_channel__cast_message__payload_type__enum_values_by_number[2] =
{
...
static const ProtobufCEnumValueIndex extensions__api__cast_channel__cast_message__payload_type__enum_values_by_name[2] =
{
  { "BINARY", 1 },
  { "STRING", 0 },
};
...
static const ProtobufCFieldDescriptor extensions__api__cast_channel__auth_response__field_descriptors[3] =
{
  {
    "signature",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_BYTES,
    offsetof(Extensions__Api__CastChannel__AuthResponse, n_client_ca),
    offsetof(Extensions__Api__CastChannel__AuthResponse, client_ca),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCEnumValue extensions__api__cast_channel__auth_error__error_type__enum_values_by_number[2] =
{
...
static const ProtobufCEnumValueIndex extensions__api__cast_channel__auth_error__error_type__enum_values_by_name[2] =
{
  { "INTERNAL_ERROR", 0 },
  { "NO_TLS", 1 },
};
